CREATE DATABASE [xyz]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'xyz', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\xyz.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'xyz_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\xyz_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
GO
...
GO
ALTER DATABASE [xyz] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
USE [xyz]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [xyz] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
